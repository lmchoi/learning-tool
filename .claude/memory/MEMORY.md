...
- [Project current state](project_setup_plan.md) — build progress, open issues (#32 next), what's planned
- [Add dependencies on a need-to basis](feedback_deps.md) — add runtime deps only when needed, not upfront
- [Always branch and PR](feedback_git_workflow.md) — never push directly to main, always work on a branch and raise a PR
- [Small focused commits](feedback_commits.md) — each logical change gets its own commit, don't bundle unrelated things
